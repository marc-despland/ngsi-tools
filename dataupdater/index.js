...
(async () => {
    ...
    console.log("Update "+argv.type+" attribute "+argv.attr+ " value "+argv.value)
    var count=await Updater.update(argv.type, argv.attr, argv.value);
    console.log("have updated "+count+ " elements")
    if (argv.delete) {
        for( var i=0; i<Data.data.length; i++) {
